...
Function t_MiniAnaPrepGV()
	...
	Variable/G SetMiniTimeInitial = 0.1
	Variable/G SetMiniTimeFinish = 0.5
	Variable/G MiniAnaScaleMax = 10e-12
	Variable/G MiniAnaScaleMin = -40e-12
	Variable/G SetMiniArtifactX = 0.05
	Variable/G SetMiniFitTimeInitial = 0.055
	Variable/G SetMiniFitTimeFinish = 1
	Variable/G DetectPeakAmp = 5e-12
...
//tb60
	Button BtSelecttWaveMini_tab60,pos={12,25},size={70,20},proc=t_SelecttWaveMini,title="tWaveMini"
	SetVariable SetVartWavemini_tab60,pos={88,28},size={100,16},title=" "
	SetVariable SetVartWavemini_tab60,value= root:Packages:MiniAna:tWaveMini
	PopupMenu PoptWave_tab60,pos={15,50},size={111,20},bodyWidth=75,proc=t_MinitWaveSelection60,title="select"
	PopupMenu PoptWave_tab60,mode=1,popvalue="w_4_0_0",value= #"wavelist(\"*\", \";\", \"\")"
	PopupMenu PoptWaveAddition_tab60,pos={19,75},size={98,20},bodyWidth=75,proc=t_MinitWaveAddition60,title="add"
	PopupMenu PoptWaveAddition_tab60,mode=1,popvalue="w_4_0_0",value= #"wavelist(\"*\", \";\", \"\")"
	ListBox MiniWaveList_tab60,pos={343,61},size={152,207},frame=2
	ListBox MiniWaveList_tab60,listWave=root:Packages:MiniAna:Mini_WaveListWave,mode= 1
	ListBox MiniWaveList_tab60,selRow= -1
	Button EditMini_tab60,pos={342,36},size={50,20},proc=t_MiniEditList,title="EditList"
	Button BtMiniDeleteListWave_tab60,pos={395,36},size={50,20},proc=t_MiniDeleteWaveList,title="Delete"
	Button BtMiniMainGetWL_tab60,pos={446,36},size={50,20},proc=t_MiniGetWaveList,title="GetWL"
	Button BtMniTablePreparation_tab60,pos={15,110},size={70,20},proc=t_MiniTablePrep,title="TablePrep"
	Button BtMniWavePreparation_tab60,pos={85,110},size={70,20},proc=t_MiniAnaWavePrep,title="WavePrep"
	Button BtDisplayInittWaveMini_tab60,pos={15,130},size={70,20},proc=t_MiniMainDisplayInitialize,title="DisplayInit"
	Button BtAutoSearch_tab60,pos={15,150},size={70,20},proc=t_MiniAutoSearch,title="AutoSearch"
	Button Bt_Abort_tab60,pos={85,150},size={70,20},proc=t_MiniAllSearch,title="AllSearch"
	Button BtReset_tab60,pos={15,190},size={50,20},title="Reset"
	Button Bt_MiniD_Rec_tab60,pos={15,240},size={50,20},proc=t_RecoveryMiniAnaDaughterGraph,title="D_Recov"
	Button BtDisplaytWaveMini_tab60,pos={85,130},size={70,20},proc=t_MiniMainDisplay,title="Display"	
	TitleBox TitleBoxRecNumber_tab60,pos={235,25},size={83,20}
	TitleBox TitleBoxRecNumber_tab60,variable= root:Packages:MiniAna:ExpRecNum
	TitleBox TitleMiniSamplingHz_tab60,pos={236,46},size={67,20}
	TitleBox TitleMiniSamplingHz_tab60,variable= root:Packages:MiniAna:SamplingHz

//tb61
	SetVariable MiniSetExpRecNum_tab61,pos={10,27},size={150,16}
	SetVariable MiniSetExpRecNum_tab61,value= root:Packages:MiniAna:ExpRecNum
	SetVariable MiniSetSampling_tab61,pos={10,46},size={150,16},title="Sampling (kHz)"
	SetVariable MiniSetSampling_tab61,value= root:Packages:MiniAna:SamplingHz	
	SetVariable MiniSetPCurrent_tab61,pos={10,66},size={150,16},title="ParentCurrent"
	SetVariable MiniSetPCurrent_tab61,limits={0,inf,1e-12},value= root:Packages:MiniAna:SetMiniPCurrent
	GroupBox GroupMiniMain_tab61,pos={8,104},size={169,73},title="Event Range (s)"
	SetVariable SetMiniTotalRange_tab61,pos={21,124},size={150,16},title="Total"
	SetVariable SetMiniTotalRange_tab61,limits={0.001,inf,0.001},value= root:Packages:MiniAna:SetMiniTotalRange
	SetVariable SetMiniBasalRange_tab61,pos={21,146},size={150,16},title="Base"
	SetVariable SetMiniBasalRange_tab61,limits={0.001,inf,0.001},value= root:Packages:MiniAna:SetMiniBasalRange
	CheckBox CheckSetDupLW_tab61,pos={19,186},size={97,14},proc=t_MiniCheck_tab61,title="Labeling Waves"
	CheckBox CheckSetDupLW_tab61,value= 1
	CheckBox CheckSetDupEW_tab61,pos={19,215},size={84,14},proc=t_MiniCheck_tab61,title="Event Waves"
	CheckBox CheckSetDupEW_tab61,value= 0
	CheckBox CheckSetDisplayEW_tab61,pos={20,242},size={76,14},title="Diplay EWs"
	CheckBox CheckSetDisplayEW_tab61,value= 0
	PopupMenu Popup_AnalysisMode_tab61,pos={196,25},size={131,20},proc=t_PopMenuProcMiniSet,title="Mode"
	PopupMenu Popup_AnalysisMode_tab61,mode=1,popvalue="Evoked Mini",value= #"\"Evoked Mini;Mini or Sponta\""
	GroupBox GroupTimeWindow_tab61,pos={202,49},size={129,62},title="TimeWindow (s)"
	SetVariable SetInitialTime_tab61,pos={219,67},size={100,16},title="From"
	SetVariable SetInitialTime_tab61,limits={0,inf,0.001},value= root:Packages:MiniAna:SetMiniTimeInitial
	SetVariable SetFinishTime_tab61,pos={219,86},size={100,16},title="To"
	SetVariable SetFinishTime_tab61,limits={0,inf,0.001},value= root:Packages:MiniAna:SetMiniTimeFinish
	GroupBox GroupScale_tab61,pos={202,119},size={129,62},title="Axis Scaling"
	SetVariable SetMiniAnaScalingMax_tab61,pos={219,137},size={100,16},title="Max"
	SetVariable SetMiniAnaScalingMax_tab61,limits={0,inf,1e-12},value= root:Packages:MiniAna:MiniAnaScaleMax
	SetVariable SetMiniAnaScalingMin_tab61,pos={219,156},size={100,16},title="Min"
	SetVariable SetMiniAnaScalingMin_tab61,limits={-inf,inf,0.001},value= root:Packages:MiniAna:MiniAnaScaleMin
	SetVariable SetArtifact_tab61,pos={347,28},size={70,16},title="ArtiX"
	SetVariable SetArtifact_tab61,value= root:Packages:MiniAna:SetMiniArtifactX
	PopupMenu Popup_Fitting_tab61,pos={347,48},size={158,20},title="BaseFit"
	PopupMenu Popup_Fitting_tab61,mode=6,popvalue="dblexp_XOffset",value= #"\"none;line;poly;lor;exp_XOffset;dblexp_XOffset;exp;dbexp;\""
	GroupBox Groupfit_tab61,pos={338,74},size={113,73},title="Fittig Range"
	SetVariable SetFitInitialTime_tab61,pos={347,91},size={70,16},title="From"
	SetVariable SetFitInitialTime_tab61,value= root:Packages:MiniAna:SetMiniFitTimeInitial
	SetVariable SetFitFinishTime_tab61,pos={347,113},size={70,16},title="To"
	SetVariable SetFitFinishTime_tab61,value= root:Packages:MiniAna:SetMiniFitTimeFinish
	CheckBox CheckFitEvent_tab61,pos={206,187},size={84,14},title="Event Fitting"
	CheckBox CheckFitEvent_tab61,value= 0

//tb62
	GroupBox GroupPeak_tab62,pos={15,25},size={237,142},title="Peak Detection"
	PopupMenu PopupPeakDetect_tab62,pos={31,41},size={87,20},title="Polarity"
	PopupMenu PopupPeakDetect_tab62,mode=1,popvalue="-",value= #"\"-;+;Å};\""
	SetVariable SetPeakAmplitude_tab62,pos={32,64},size={150,16},title="Amp (A or V)"
	SetVariable SetPeakAmplitude_tab62,limits={0,inf,1e-12},value= root:Packages:MiniAna:DetectPeakAmp
	SetVariable SetPeakfromSD_tab62,pos={33,87},size={75,16},title="Å~S.D."
	SetVariable SetPeakfromSD_tab62,limits={0,inf,1},value= root:Packages:MiniAna:DetectPeakSD
	SetVariable SetPeakBox_tab62,pos={28,119},size={100,16},title="Smoothing"
	SetVariable SetPeakBox_tab62,limits={0,inf,1},value= root:Packages:MiniAna:DetectSmoothingBox
	SetVariable SetTightnessBack_tab62,pos={26,141},size={90,16},title="TightBack"
	SetVariable SetTightnessBack_tab62,limits={0,inf,1},value= root:Packages:MiniAna:DetecttightBack
	SetVariable SetTightness_tab62,pos={132,141},size={90,16},title="Tightness"
	SetVariable SetTightness_tab62,limits={0,inf,1},value= root:Packages:MiniAna:Detecttightness
	CheckBox CheckMADetectArea_tab62,pos={27,174},size={16,14},title="",value= 1
	SetVariable SetArea_tab62,pos={47,172},size={123,16},title="Area"
	SetVariable SetArea_tab62,limits={0,inf,1e-15},value= root:Packages:MiniAna:DetectArea
	SetVariable SetAreaRange_tab62,pos={174,173},size={80,16},title="Range"
	SetVariable SetAreaRange_tab62,limits={0,inf,0.001},value= root:Packages:MiniAna:DetectAreaDecayRange
	GroupBox GroupFitting_tab62,pos={15,194},size={237,75},title="Fitting Parameters"
	GroupBox GroupIsolate_tab62,pos={287,29},size={208,64},title="Isolating Criteria"
	SetVariable SetDetect_IsoCri_tab62,pos={300,50},size={150,16}
	SetVariable SetDetect_IsoCri_tab62,limits={0,inf,0.01},value= root:Packages:MiniAna:DetectIsoCriteria

//tb63
	GroupBox GroupField0_tab63,pos={11,23},size={198,113},title="default"
	CheckBox CheckExpRecNum_tab63,pos={20,40},size={80,14},proc=t_MAFieldCheck,title="ExpRecNum"
	CheckBox CheckExpRecNum_tab63,value= 1
	CheckBox CheckWaveName_tab63,pos={19,58},size={74,14},proc=t_MAFieldCheck,title="WaveName"
	CheckBox CheckWaveName_tab63,value= 1
	CheckBox CheckSamplingHz_tab63,pos={19,76},size={77,14},proc=t_MAFieldCheck,title="SamplingHz"
	CheckBox CheckSamplingHz_tab63,value= 1
	CheckBox CheckParentCurrent_tab63,pos={19,90},size={63,14},proc=t_MAFieldCheck,title="PCurrent",value= 1
	CheckBox CheckIsolateTag_tab63,pos={20,108},size={71,14},proc=t_MAFieldCheck,title="IsolateTag",value= 1
	CheckBox CheckSerial_tab63,pos={120,44},size={70,14},proc=t_MAFieldCheck,title="SerialNum", value = 1
	CheckBox CheckXLock_tab63,pos={121,65},size={69,14},proc=t_MAFieldCheck,title="XLock", value = 1
	CheckBox CheckALockedX_tab63,pos={122,85},size={69,14},proc=t_MAFieldCheck,title="ALockedX", value = 1
	CheckBox CheckInitialX_tab63,pos={123,103},size={53,14},proc=t_MAFieldCheck,title="InitialX",value= 1
	CheckBox CheckInterEventInterval_tab63,pos={123,119},size={66,14},proc=t_MAFieldCheck,title="IEInterval",value= 1
	CheckBox CheckBase_tab63,pos={124,143},size={44,14},proc=t_MAFieldCheck,title="Base", value = 1
	CheckBox CheckError_tab63,pos={125,162},size={43,14},proc=t_MAFieldCheck,title="Error",value= 1
	CheckBox CheckPeak_tab63,pos={19,144},size={43,14},proc=t_MAFieldCheck,title="Peak", value = 1
	CheckBox CheckArea_tab63,pos={20,161},size={42,14},proc=t_MAFieldCheck,title="Area", value = 1
	CheckBox CheckDecay_tab63,pos={20,176},size={50,14},proc=t_MAFieldCheck,title="Decay", value = 1
	CheckBox CheckDRise_tab63,pos={20,193},size={41,14},proc=t_MAFieldCheck,title="Rise", value = 1

//tb64
	Button BtHelp_tab64,pos={20,30},size={50,20},proc= t_MiniAnaHelpNote,title="Help"

//
	ModifyControlList ControlNameList("",";","!*_tab60") disable=1
...
Function t_TabProc05 (ctrlName, tabNum) : TabControl
	String ctrlname
	Variable tabNum
	String controlsInATab= ControlNameList("",";","*_tab6*")
	String curTabMatch="*_tab6"+Num2str(tabNum)
...
Function t_SelecttWaveMini(ctrlName) : ButtonControl
	...
	ControlInfo/W=MiniAnaMain MiniWaveList_tab60
...
Function t_MiniMainDisplayInitialize(ctrlName) : ButtonControl
	...
	ControlInfo/W=MiniAnaMain CheckSetDupLW_tab61
	If(V_value)
...
Function t_MiniTablePrep(ctrlName) : ButtonControl
	...
	SetDatafolder root:Packages:MiniAna:
	Variable labelnum = 0
	ControlInfo/W=MiniAnaMain CheckSerial_tab63
	If(V_value)
		If(Exists("Serial") != 1)
			Make/N=0 Serial
		endif
	...
	ControlInfo/W=MiniAnaMain CheckWaveName_tab63
	If(V_value)
		If(Exists("wvName") != 1)
			Make/T/N=0 wvName
		endif
	...
	ControlInfo/W=MiniAnaMain CheckXLock_tab63
	If(V_value)
		If(Exists("XLock") != 1)
			Make/N=0 XLock
		endif
	...
	ControlInfo/W=MiniAnaMain CheckALockedX_tab63
	If(V_value)
		If(Exists("ALocked") !=1)
			Make/N=0 ALocked
		endif
	...
	ControlInfo/W=MiniAnaMain CheckInitialX_tab63
	If(V_value)
	...
	ControlInfo/W=MiniAnaMain CheckIsolateTag_tab63
	If(V_value)
		If(Exists("Isolate") != 1)
			Make/N=0 Isolate
		endif
	...
	ControlInfo/W=MiniAnaMain CheckBase_tab63	
	If(V_value)
		If(Exists("Base") != 1)
			Make/N=0 Base
		endif
	...
	ControlInfo/W=MiniAnaMain CheckPeak_tab63	
	If(V_value)
		If(Exists("Peak") != 1)
			Make/N=0 Peak
		endif
	...
	ControlInfo/W=MiniAnaMain CheckArea_tab63	
	If(V_value)
		If(Exists("AreaUC") != 1)
			Make/N=0 AreaUC
		endif
	...
	ControlInfo/W=MiniAnaMain CheckDecay_tab63	
	If(V_value)
		If(Exists("Decay") != 1)
			Make/N=0 Decay
		endif
	...
	ControlInfo/W=MiniAnaMain CheckRise_tab63	
	If(V_value)
		If(Exists("Rise") != 1)
			Make/N=0 Rise
		endif
	...
	ControlInfo/W=MiniAnaMain CheckExpRecNum_tab63	
	If(V_value)
		If(Exists("RecNum") != 1)
			Make/T/N=0 RecNum
		endif
	...
	ControlInfo/W=MiniAnaMain CheckSamplingHz_tab63	
	If(V_value)
	...
	ControlInfo/W=MiniAnaMain CheckParentCurrent_tab63
	If(V_value)
	...
	ControlInfo/W=MiniAnaMain CheckError_tab63
	If(V_value)
		If(Exists("Error") != 1)
			Make/N=0 Error
		endif
...
Function t_MiniAutoSearch(ctrlName) : ButtonControl
	...
	ControlInfo/W=MiniAnaMain Popup_Fitting_tab61
	...
	ControlInfo/W=MiniAnaMain Popup_AnalysisMode_tab61
	...
	//PeakFindings
	ControlInfo/W=MiniAnaMain PopupPeakDetect_tab62
...
Function t_PopMenuProcMiniSet(ctrlName,popNum,popStr) : PopupMenuControl
	...
	Switch (popNum)
		case 1:
			GroupBox GroupTimeWindow_tab61 disable = 0, win = MiniAnaMain
			SetVariable SetInitialTime_tab61 disable = 0, win = MiniAnaMain
			SetVariable SetFinishTime_tab61 disable = 0, win = MiniAnaMain
			break
		case 2:
			GroupBox GroupTimeWindow_tab61 disable = 2, win = MiniAnaMain
			SetVariable SetInitialTime_tab61 disable = 2, win = MiniAnaMain
			SetVariable SetFinishTime_tab61 disable = 2, win = MiniAnaMain
...
Function t_MAFieldCheck(ctrlName,checked) : CheckBoxControl
	...
	Variable checked
	StrSwitch (ctrlName)
		case "CheckPeak_tab63":
			If(checked)
//				PopupMenu PopupPeakDetect_tab62 disable=0, win = MiniAnaMain
//				SetVariable SetPeakAmplitude_tab62 disable=0, win = MiniAnaMain
//				SetVariable SetPeakAmplitude_tab62 disable=0, win = MiniAnaMain				
			else
//				PopupMenu PopupPeakDetect_tab62 disable=2, win = MiniAnaMain
//				SetVariable SetPeakAmplitude_tab62 disable=2, win = MiniAnaMain
//				SetVariable SetPeakAmplitude_tab62 disable=2, win = MiniAnaMain
			endIf
			break
		default:
...
Function t_MiniCheck_tab61(ctrlName,checked) : CheckBoxControl
	String ctrlName
	Variable checked

	If(StringMatch(ctrlName, "CheckSetDupEW_tab61"))
		Switch (checked)
			case 0:
				CheckBox CheckSetDisplayEW_tab61 disable=2,value=0, win = MiniAnaMain
				break
			case 1:
				CheckBox CheckSetDisplayEW_tab61 disable=0, win = MiniAnaMain
				break
			default:
				break
		endSwitch
...
Function t_MiniD_PreSweep(ctrlName) : ButtonControl
	...
	Wave/T ListWave = root:Packages:MiniAna:Mini_WaveListWave
	ControlInfo/W=MiniAnaMain MiniWaveList_tab60
	ListBox /Z MiniWaveList_tab60 win=MiniAnaMain, selRow=(V_Value-1), row = (V_Value)
	tWaveMini = ListWave[V_Value-1]
	DoUpdate

	//Display Button
	t_MiniMainDisplay("BtDisplaytWaveMini_tab60")
